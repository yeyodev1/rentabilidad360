...
<template>
  <div class="ob-ingredients-container">
    ...
    <div class="ob-ingredients-editor">
      ...
      <button v-if="!modelValue.skipped" class="ob-skip-btn" @click="skipStep"><i class="fa-regular fa-circle-xmark" /> No tengo ingredientes ahora, los agregaré después</button>
      <div v-else class="ob-skipped-banner"><i class="fa-solid fa-forward-step" /><span>Omitiste los ingredientes. Puedes agregarlos después desde Costos → Ingredientes.</span><button class="ob-undo-btn" @click="undoSkip">Agregar ahora</button></div>
    </div>
  </div>
</template>
